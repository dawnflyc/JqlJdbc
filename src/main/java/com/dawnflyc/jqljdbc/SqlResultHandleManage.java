...
public class SqlResultHandleManage {
    ...
    private static final Set<ISqlResultHandle> sqlResultHandles = new HashSet<ISqlResultHandle>();

    /**
     * 加载便扫描
     */
    static {
        Set<Class<? extends ISqlResultHandle>> subTypesOf = new Reflections("com.dawnflyc.jql").getSubTypesOf(ISqlResultHandle.class);
